...
public class SVMRecognition {
    ...
    public static void testingTheClassifier(Instances testingInstances) {
        try {
            ...
            Classifier classifier = com.hoho.android.usbserial.examples.SerialConsoleActivity.getClassifierSVMH();
    ...
    public void init() throws Exception {
        ...
        //modelPath = jo.getString("modelPathH");

        csvPath = "config"+"/devices/" + device_Name + "/csv/" + csvPath;
        //modelPath = "config"+"/devices/" + device_Name+ "/models/" + modelPath;
        //training the classifier.
        try {
            classifier = com.hoho.android.usbserial.examples.SerialConsoleActivity.getClassifierSVMH();
        } catch (Exception ex) {
